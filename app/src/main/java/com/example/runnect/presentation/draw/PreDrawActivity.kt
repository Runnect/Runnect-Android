...
import com.example.runnect.databinding.ActivityPreDrawBinding
...
class PreDrawActivity : BindingActivity<ActivityPreDrawBinding>(R.layout.activity_pre_draw),
    OnMapReadyCallback {
    ...
    override fun onMapReady(map: NaverMap) {
        ...
        //네이버 맵 sdk에 위치 정보 제공
        locationSource = FusedLocationSource(this@PreDrawActivity, LOCATION_PERMISSION_REQUEST_CODE)
